...
((function() {
 var loadPackage = (function(metadata) {
  ...
  var PACKAGE_NAME = "OpenLara_wasm.data";
  var REMOTE_PACKAGE_BASE = "OpenLara_wasm.data";
  ...
  function runWithFS() {
   ...
   function processPackageData(arrayBuffer) {
    ...
    Module["removeRunDependency"]("datafile_OpenLara_wasm.data");
   }
   Module["addRunDependency"]("datafile_OpenLara_wasm.data");
 ...
 loadPackage({
  ...
  "package_uuid": "b37863ec-8d77-4f39-b5e6-eecb0b27fcf1"
 });
}))();
var Module;
